        ...
        <div className="flex flex-col md:flex-row">
          <div className="relative h-48 flex-shrink-0 overflow-hidden md:h-auto md:w-64">
            {post.coverImage ? (
              ...
              <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-sky-500/20 to-blue-500/20">
          ...
          <CardContent className="flex flex-1 flex-col justify-between p-6">
            <div>
              ...
              <h2 className="mb-2 text-xl font-semibold transition-colors group-hover:text-sky-400">
                {post.title}
              </h2>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="flex items-center gap-1 text-sm font-medium text-sky-400 opacity-0 transition-opacity group-hover:opacity-100">
                Read more
